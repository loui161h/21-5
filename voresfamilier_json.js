...
function visDataVoresFamilier() {
    ...
    document.querySelector("#voresfamilier_overskrift2").textContent = alleTekster.overskrift1;
    document.querySelector("#voresfamilier_p2").innerHTML = alleTekster.tekst1;
